<template>
    <div class="copon">
        <div class="top">
            <span class="top-text" v-bind:class="{click:unused}" @click="show(0)">未使用</span>
            <span class="top-text" v-bind:class="{click:used}" @click="show(1)">已使用</span>
...
<style lang="scss" scoped>
    ...
    .copon{
        ...
        .coupon-top{
            ...
            width: 780*$rem;
            height: 350*$rem;
            background: url(~@/assets/jjqbackimg.png) no-repeat scroll;
            background-size: 100%;
            margin-top: 0.5rem;
            .discount{
                color: #eb1314;
        ...
        .top{
            ...
            border-top: 1px solid rgb(214, 215, 220);
            ...
            .top-text{
                ...
                height: 100%;
                width: 33.3%;
                border-right: 1px solid rgb(214, 215, 220);
            }
        }
        .hint-top{
            //width: 100%;
