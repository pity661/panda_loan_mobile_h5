		...
		data() {
			return {
                ...
                listAnswer: [
                    ...
                    {value:"打开小花白卡APP，可根据自己的贷款需求，从首页的新品推荐、苹果专区、用信用卡、用公积金贷等专区进入产品列表页，也可以浏览贷款产品进行选择。"},
                    {value:"不同的贷款产品，对借款人的要求不同。在小花白卡APP上，展示了每一款贷款产品的金额和费用等信息，选择与自身匹配度高的产品，申请成功率更高。"},
                    {value:"小花白卡为您搜集整理了，市场上主流的贷款产品。据统计，同时申请7家以上的产品，通过率能达到90%以上。"},
                    {value:"小花白卡APP提供给借款人不同额度区间的多款贷款产品，依据借款人的个人资质，贷款产品的额度高低也不一样。建议在申请时保证个人信息填写正确、完整，贷款机构要求验证的材料尽量充分验证，有助于额度的提升。"},
                    {value:"小花白卡APP上有众多的贷款产品，从申请、审核到最终放款，快至1小时完成。因不同贷款产品的审核时间有所差异，您提供的信息越完整，验证材料越充分，审核速度就越快。"},
                    ...
                    {value:"小花白卡APP提供微信公众号服务，您可以关注“熊猫元宝”后进行留言，客服人员会在线为您解答。"}
                ],
                questionNum: '',
                show: true
            }
