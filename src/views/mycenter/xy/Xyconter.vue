...
export default {
    ...
    methods: {
        ...
        goHelp(){
            window.location.href="http://www.pinganzhiyuan.com/panda_loan_mobile_web/xyhelpcenter"
        },
        goabouts(){
            window.location.href="http://www.pinganzhiyuan.com/panda_loan_mobile_web/xyaboutus"
        }
    },
  mounted(){
