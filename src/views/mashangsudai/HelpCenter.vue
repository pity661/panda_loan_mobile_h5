		...
		data() {
			return {
                listQuestion: [
                    ...
                    {value:"申请马上速贷的条件是什么？"},
                    {value:"如何申请马上速贷？"},
                    {value:"申请贷款后，平台会联系我填写的联系人吗？"},
                    {value:"为什么拒绝我的贷款申请？"},
                    {value:"贷款申请被拒绝后还可以再申请吗？"},
                    {value:"我申请的贷款什么时间到账？"},
                    {value:"马上速贷支持哪些还款方式？"},
                    {value:"平台什么时间进行自动扣款？"}
                ],
                listAnswer: [
                    {value:"马上速贷是福建泰宁晋农商大金湖村镇银行股份有限公司为互联网用户提供的无抵押、无担保的信用贷款服务平台。"},
                    {value:"年满十八周岁且具有中华人民共和国法律规定的完全民事行为能力人。"},
                    {value:"用户可通过马上速贷APP按照操作提示，申请贷款。"},
                    {value:"平台仅在客户未能如期偿还贷款时，联系客户申请时填写的联系人。"},
                    {value:"对于不符合贷款要求的借款申请，平台将拒绝贷款申请。"},
                    {value:"贷款申请被审批拒绝后，过后再次提交借款申请。"},
                    {value:"马上速贷平台可在借款申请审核通过后的24小时内，完成放款。"},
                    {value:"马上速贷同时支持系统自动划扣和客户主动还款两种方式。"},
                    {value:"系统会在账单的到期还款日自动从用户绑定的银行借记卡上划扣相应金额。"}
                ],
                questionNum: '',
                show: true
            }
